...
```bash
# トークン単価（2025年11月時点）
# Claude Haiku 4.5:   入力 $1.00/1M   出力 $5.00/1M
# Claude Sonnet 4.5:  入力 $3.00/1M   出力 $15.00/1M
# Claude Opus 4.1:    入力 $15.00/1M  出力 $75.00/1M

# タスク別推奨モデル (2025年11月時点)
/model haiku     # 簡単な質問、リファクタリング
/model sonnet    # コード生成、デバッグ(推奨)
/model opus      # 複雑な設計、アーキテクチャ

# 注: claude-3-haikuやclaude-3-opusは廃止されました
```
